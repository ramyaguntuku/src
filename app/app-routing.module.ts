...
const routes: Routes = [
  ...
  {path : 'memberdetailsOutputModule', component : MemberdetailsOutputComponent},
...
export const routingComponents = [LoginModuleComponent,MemberModuleComponent,
  ContactModuleComponent,MemberdetailsModuleComponent,MemberdetailsOutputComponent,ClaimInputComponent,
